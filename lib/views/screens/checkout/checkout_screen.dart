  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: GetBuilder<CreateInvoiceController>(
            init: Get.find<CreateInvoiceController>(),
            builder: (invoice) {
              return Visibility(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ListView.separated(
                        itemCount: invoice.paymentGatewayList?.paymentList
                                ?.first.paymentMethodList?.length ??
                            0,
                        itemBuilder: (context, index) {
                          var item = invoice.paymentGatewayList?.paymentList
                              ?.first.paymentMethodList![index];
                          return ListTile(
                            onTap: () {
